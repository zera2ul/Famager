...
# Do not prefix with './'
source.exclude_patterns = license,images/*/*.jpg, database/reset.py,  database/refresh.py, requirements.txt
...
android.add_libs_arm64_v8a = libpq.so
